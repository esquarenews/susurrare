...
- Latest/default: `gpt-live-transcribe` for live audio and `gpt-transcribe` for completed recordings
- Fast (legacy): `gpt-4o-mini-transcribe`
- Accurate (legacy): `gpt-4o-transcribe`
- Meetings (diarize): `gpt-4o-transcribe-diarize`
- Whisper (legacy, non-streaming): `whisper-1`
